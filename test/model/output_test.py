...
class OutputTest(unittest.TestCase):
    ...
    def test_connect(self):
        ...
        patch.observer.onConnectionUpdated.assert_called_with(new_connection, UpdateType.CREATED)
    ...
    def test_disconnect(self):
        ...
        self.assertEqual(1, len(patch.connections))
        patch.observer.onConnectionUpdated.assert_called_with(disconnected, UpdateType.DELETED)
    ...
    def test_disconnect_connection_not_created(self):
        ...
        patch.observer.onConnectionUpdated.assert_not_called()
